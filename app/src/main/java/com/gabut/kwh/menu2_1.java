...
public class menu2_1 extends AppCompatActivity {
    ...
    EditText editTextNama, editTextAlamat, editTextEmail, editTextTelp, editTextDeskripsi;
    String GetNama, GetAlamat, GetEmail, GetTelp, GetDeskripsi;
    Button simpan;

    String DataParseUrl = "http://gokwh.net/kuliner.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SendDataToServer(GetNama, GetAlamat, GetEmail, GetTelp, GetDeskripsi);
    ...
    public void SendDataToServer(final String nama, final String alamat, final String email, final String telp, final String deskripsi){
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                Toast.makeText(menu2_1.this, "Data Anda Sudah Terkirim", Toast.LENGTH_LONG).show();
