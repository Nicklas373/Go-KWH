...
public class menu4_1 extends AppCompatActivity {
    ...
    String HttpUrl =  "http://gokwh.net/fashion.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu4_1);
        ...
        requestQueue = Volley.newRequestQueue(menu4_1.this);

        progressDialog = new ProgressDialog(menu4_1.this);
    ...
    public void AlertDialogCreate() {
        ...
        new AlertDialog.Builder(menu4_1.this)
                ...
                .setPositiveButton("Simpan", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (Nama.getText().toString().length() == 0) {
                            Toast.makeText(menu4_1.this, "Harap Masukkan Nama Anda", Toast.LENGTH_SHORT).show();
                            Nama.setError("Harap Masukan Nama Anda");
                        } else if (Alamat.getText().toString().length() == 0) {
                            Toast.makeText(menu4_1.this, "Harap Masukkan Alamat Anda", Toast.LENGTH_SHORT).show();
                            Alamat.setError("Harap Masukkan Alamat Anda");
                        } else if (Email.getText().toString().length() == 0) {
                            Toast.makeText(menu4_1.this, "Harap Masukkan E-Mail Anda", Toast.LENGTH_SHORT).show();
                            Email.setError("Harap Masukkan E-Mail Anda");
                        } else if (Telp.getText().toString().length() == 0) {
                            Toast.makeText(menu4_1.this, "Harap Masukkan Nomor Telepon Anda", Toast.LENGTH_SHORT).show();
                            Telp.setError("Harap Masukkan Nomor Telepon Anda");
                        } else if (Usaha.getText().toString().length() == 0) {
                            Toast.makeText(menu4_1.this, "Harap Masukkan Usaha Anda", Toast.LENGTH_SHORT).show();
                            Usaha.setError("Harap Masukkan Usaha Anda");
                        } else if (Deskripsi.getText().toString().length() == 0) {
                            Toast.makeText(menu4_1.this, "Harap Masukkan Deskripsi Anda", Toast.LENGTH_SHORT).show();
                            Deskripsi.setError("Harap Masukkan Deskripsi Anda");
                        } else {

                        Toast.makeText(menu4_1.this, "Menginput Data", Toast.LENGTH_SHORT).show();
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
                                new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String ServerResponse) {
                                        ...
                                        Toast.makeText(menu4_1.this, ServerResponse, Toast.LENGTH_LONG).show();
                                    }
                                },
                                new Response.ErrorListener() {
                                    ...
                                    public void onErrorResponse(VolleyError volleyError) {
                                        ...
                                        Toast.makeText(menu4_1.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                                    }
                                }) {
                            @Override
                        ...
                        RequestQueue requestQueue = Volley.newRequestQueue(menu4_1.this);

                        // Adding the StringRequest object into requestQueue.
                        requestQueue.add(stringRequest);

                        Intent intent = new Intent(menu4_1.this, MainActivity.class);
                ...
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(menu4_1.this, "Harap Periksa Data Anda Kembali", Toast.LENGTH_SHORT).show();
                    }
                }).show();
    }
}